...
def load_path1(train_path, train_mask_path, test_path, test_mask_path):
    train_ids = sorted(glob(os.path.join(train_path, "*")))
    train_mask_ids = sorted(glob(os.path.join(train_mask_path, "*")))
    test_ids = sorted(glob(os.path.join(test_path, "*")))
    test_mask_ids = sorted(glob(os.path.join(test_mask_path, "*")))
    return train_ids, train_mask_ids, test_ids, test_mask_ids
